...
#### Time spent ####
time.data=read.csv('data/time_data_multinomial.csv') %>%
...
simul.data=read.csv('data/simul_data_multinomial.csv') %>%
  mutate(model=ifelse(model=='kdglm','kDGLM','STAN'))
...
ggsave(
  'Figures/multinomial_simul_short1.pdf',
  device='pdf',
  units='px',
  width=width,
  height=height,
...
ggsave(
  'Figures/multinomial_simul_short2.pdf',
  device='pdf',
  units='px',
  width=width,
  height=height,
...
ggsave(
  'Figures/multinomial_simul_long1.pdf',
  device='pdf',
  units='px',
  width=width,
  height=height
...
ggsave(
  'Figures/multinomial_simul_long2.pdf',
  device='pdf',
  units='px',
  width=width,
  height=height
...
ggsave(
  'Figures/multinomial_simul_long3.pdf',
  device='pdf',
  units='px',
  width=width,
  height=height
...
ggsave(
  'Figures/multinomial_simul_long4.pdf',
  device='pdf',
  units='px',
  width=width,
  height=height
