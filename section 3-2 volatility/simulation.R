...
if(FALSE){
  ...
  model=stan_model(file='section 3-2 volatility/volat_model_sim.stan')
  ...
  # Saving the model
  save(stan_smp,file='section 3-2 volatility/stan_fit_simul.bkp')
}else{
  # Loading the model
  load(file='section 3-2 volatility/stan_fit_simul.bkp')
}
